...
public final class Join {
	 ...
	 */
	public static String join(String delimiter, Object firstToken,
			Object... otherTokens) {
	...
	private static CharSequence toCharSequence(Object token) {
		return (token instanceof CharSequence) ? (CharSequence) token : String
				.valueOf(token);
	}

	/**
	 * Thrown in response to an {@link IOException} from the supplied
	 * {@link Appendable}. This is used because most callers won't want to worry
	 * about catching an IOException.
	 */
