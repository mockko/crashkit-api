...
DATABASE_NAME = 'sample.sqlite'# Or path to database file if using sqlite3.
...
SECRET_KEY = 'gp(j_^+7hiqg%5(y^w@+0mvjfh!dppjz%xyybe^pkumyed+cr-'
...
ROOT_URLCONF = 'crashkit_django.urls'
